...
public class GenericGF {
    ...
    private final com.example.android2unity.GenericGFPoly zero;

    private final com.example.android2unity.GenericGFPoly one;
    ...
    public GenericGF(int primitive, int size, int b) {
        ...
        zero = new com.example.android2unity.GenericGFPoly(this, new int[]{0});

        one = new com.example.android2unity.GenericGFPoly(this, new int[]{1});

    }



    com.example.android2unity.GenericGFPoly getZero() {
    ...
    com.example.android2unity.GenericGFPoly getOne() {
    ...
    com.example.android2unity.GenericGFPoly buildMonomial(int degree, int coefficient) {
        ...
        return new com.example.android2unity.GenericGFPoly(this, coefficients);
